...
********************************************************************************
* @file    lora.h
* @author  Rasmus Källqvist, based on code by Sandeep Mistry
* @version V1.0.0
* @date    08-May-2018
* @brief   Header file for LoRa.c
********************************************************************************
*/	
...
/* SPI access mode */
#define WNR_READ_ACCESS          0x7F // AND with this, msb = 0
#define WNR_WRITE_ACCESS         0x80 // OR with this , msb = 1
